...
int main(void)
{
    ...
    Mat img_kpts1;
    drawKeypoints( img1, kpts1, img_kpts1, Scalar::all(-1), DrawMatchesFlags::DRAW_RICH_KEYPOINTS );
    ...
    imshow ("drawMatches", res);

    string outfile = "res.png";
    imwrite(outfile, res);
